...
function SheetContent({
  ...
  VariantProps<typeof sheetVariants>): React.ReactElement {
  return (
    <SheetPortal>
      <SheetOverlay />
      ...
      >
        {children}
        <SheetPrimitive.Close className="focus-visible:ring-ring focus-visible:ring-offset-background absolute right-4 top-4 rounded-sm opacity-70 outline-none transition-opacity hover:opacity-100 focus-visible:ring-2 focus-visible:ring-offset-2 disabled:pointer-events-none">
          <X className="size-4" />
